...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { direccion: @empleado.direccion, nombre: @empleado.nombre, rfc: @empleado.rfc, seguro_social: @empleado.seguro_social, telefono: @empleado.telefono }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { direccion: @empleado.direccion, nombre: @empleado.nombre, rfc: @empleado.rfc, seguro_social: @empleado.seguro_social, telefono: @empleado.telefono }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
