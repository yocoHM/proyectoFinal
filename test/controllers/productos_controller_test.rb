...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { color: @producto.color, especificaciones: @producto.especificaciones, m2: @producto.m2, nombre: @producto.nombre, presentacion: @producto.presentacion }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { color: @producto.color, especificaciones: @producto.especificaciones, m2: @producto.m2, nombre: @producto.nombre, presentacion: @producto.presentacion }
    assert_redirected_to producto_path(assigns(:producto))
  end
